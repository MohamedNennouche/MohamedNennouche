...
\section{~~Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {\scriptsize \textit{ \footnotesize{\newline{}\textbf{Courses:} Analog and digital electronics, embedded systems, embedded computing (C-C++), telecomunication, advanced signal processing, image processing, machine learning}}}
    \resumeSubheading
      {Ecole Nationale Polytechnique}{Algiers, Algeria}
      {Master's degree - Signal and Telecomunication;  17/20}{Septembre 2017 - July 2022}
      {\scriptsize \textit{ \footnotesize{\newline{}\textbf{Courses:} Telecommunication, antenna, antenna processing, Machine Learning, embedded computing, machine learning}}}
...
\section{Skills Summary}
	...
	\resumeSubItem{Tools}{~~~~~~~~~~~~~~GIT, PostgreSQL, MySQL, SQLite, Office suite, Google Data Studio, Quicksight, Power BI}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Data Analyst (Full-time)}{July 2022 - Present}
    \resumeItemListStart
        \resumeItem{Role}
